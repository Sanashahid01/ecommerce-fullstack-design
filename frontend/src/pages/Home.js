...
function Home() {
  ...
  const featuredProducts = [
    ...
    { id: 3, name: 'Men Sneakers', price: 2499, originalPrice: 3999, rating: 4.5, reviews: 234, image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&h=300&fit=crop' },
  ...
  const categories = [
    ...
    { name: 'Women', image: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=200&h=200&fit=crop' },
            ...
            {categories.map((cat, index) => (
              <Link key={index} to="/products" style={{textDecoration: 'none'}}>
                <div style={styles.categoryCard}>
                  <img src={cat.image} alt={cat.name} style={styles.categoryImage} onError={(e) => {e.target.src = 'https://placehold.co/200x200/7B1FA2/FFFFFF?text=' + cat.name}} />
          ...
          <div style={styles.productGrid}>
            {featuredProducts.map(product => (
              <div key={product.id} style={styles.productCard}>
                ...
                <img src={product.image} alt={product.name} style={styles.productImage} onError={(e) => {e.target.src = 'https://placehold.co/400x300/FF7043/FFFFFF?text=' + encodeURIComponent(product.name)}} />
